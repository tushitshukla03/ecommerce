...
function Login() {
    ...
    const handleSubmit = async (e)=>{
        ...
        let res = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/login`, requestOptions);
...
theme="light"
/>
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:-my-28 md:h-screen lg:py-0">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" >
                    ...
                    <p className="text-sm font-light text-gray-500">
                        Don&apos;t have an account? <Link href={'/signup'} className="font-medium text-primary-600 hover:underline ">SignUp here</Link>
                    </p>
                    <p className="text-sm font-light text-gray-500">
                        <Link href={'/forget'} className="font-medium text-primary-600 hover:underline ">Forget password</Link>
                    </p>
                </form>
            </div>
        </div>
